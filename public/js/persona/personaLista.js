        ...
        "fnServerData": function (sSource, aoData, fnCallback, oSettings) {
            ...
            oSettings.jqXHR = $.ajax({
                ...
                "data":{NumeroPagina:iNroPagina,NumeroRegistros:iCantMostrar,
						numero_documento:numero_documento,persona:persona,estado:estado,_token:_token
                       },
                "success": function (result) {
                    fnCallback(result);
                },
        ...
        "aoColumnDefs":
            [	
                ...
                "mRender": function (data, type, row) {
					...
					if(row.id_tipo_documento!= null)id_tipo_documento = row.id_tipo_documento;
                ...
                "mRender": function (data, type, row) {
                    var documento = "";
					if(row.documento!= null)documento = row.documento;
					return documento;
                },
                "bSortable": false,
                "aTargets": [1]

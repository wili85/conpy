...
function fn_save_litigante(){
    
	var _token = $('#_token').val();
	var id = $('#id').val();
	var id_persona = $('#id_persona').val();
	var id_empresa = $('#id_empresa').val();
	var id_tipo_litigante = $('#id_tipo_litigante').val();
	var estado_lit = $('#estado_lit').val();
	
    $.ajax({
			url: "/expediente/send_litigante",
            type: "POST",
            data : {_token:_token,id:id,id_persona:id_persona,id_empresa:id_empresa,id_tipo_litigante:id_tipo_litigante,estado_lit:estado_lit},
    ...
    <div>
		...
		<div class="card">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top:5px;padding-bottom:20px">
					...
					if($litigante->id > 0){
						if($litigante->id_persona > 0){
							$display_empresa="display:none";
							$display_persona="display:block";
							$checked_tipo = "";
						}
						
						if($litigante->id_empresa > 0){
					...
					<div class="row" style="padding-left:10px">
						...
						<div class="col-lg-12">
							<div class="form-group">
								<label class="control-label form-control-sm">Tipo Litigante</label>
								<select name="id_tipo_litigante" id="id_tipo_litigante" class="form-control form-control-sm" onChange="">
									<option value="">--Seleccionar--</option>
									<?php
									foreach ($tipo_litigante as $row) {?>
									<option value="<?php echo $row->codigo?>" <?php if($row->codigo==$litigante->id_tipo_litigante)echo "selected='selected'"?> ><?php echo $row->denominacion?></option>
									<?php 
									}
									?>
								</select>
						...
						<div class="col-lg-12">
							<div class="form-group">
								...
								<select name="estado_lit" id="estado_lit" class="form-control form-control-sm" onChange="">
									<option value="">--Seleccionar--</option>
									<?php
									foreach ($estado_litigante as $row) {?>
									<option value="<?php echo $row->codigo?>" <?php if($row->codigo==$litigante->estado_lit)echo "selected='selected'"?>><?php echo $row->denominacion?></option>
									<?php 
									}
									?>
								</select>
							...
							<div class="form-group">
								...
								<div style="padding-right:0px;padding-left:0px;text-align:center;float:left">
									...
									<label class="switch" style="float:left">
										<input type="checkbox" <?php echo $checked_tipo?> id="tipo_proveedor_" onChange="cargar_tipo_proveedor()"/>
										<span class="slider round"></span>
									</label>
									<span class="si">Empresa</span>
					...
					<div class="row" id="divPersona" style="padding-left:10px;<?php echo $display_persona?>">
						
						<div class="col-lg-12">
							<div class="form-group">
								<label class="control-label form-control-sm">Persona</label>
								<input id="persona_" name="persona_" class="form-control form-control-sm ui-autocomplete-input" value="<?php if($litigante->id > 0 && $litigante->id_persona>0)echo $litigante->litigante;?>" type="text" autocomplete="off">
								<input id="id_persona" name="id_persona" class="form-control form-control-sm" value="<?php if($litigante->id > 0 && $litigante->id_persona>0)echo $litigante->id_persona;?>" type="hidden">
					...
					<div class="row" id="divEmpresa" style="padding-left:10px;<?php echo $display_empresa?>">
						
						<div class="col-lg-12">
							<div class="form-group">
								<label class="control-label form-control-sm">Empresa</label>
								<input id="empresa_" name="empresa_" class="form-control form-control-sm" value="<?php if($litigante->id > 0 && $litigante->id_empresa>0)echo $litigante->litigante;?>" type="text" autocomplete="off">
								<input id="id_empresa" name="id_empresa" class="form-control form-control-sm"  value="<?php if($litigante->id > 0 && $litigante->id_empresa>0)echo $litigante->id_empresa;?>" type="hidden">
					...
					<div style="margin-top:15px" class="form-group">
						<div class="col-sm-12 controls">
							<div class="btn-group btn-group-sm float-right" role="group" aria-label="Log Viewer Actions">
								<a href="javascript:void(0)" onClick="fn_save_litigante()" class="btn btn-sm btn-success">Guardar</a>
							</div>

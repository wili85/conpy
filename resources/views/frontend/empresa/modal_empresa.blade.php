...
function fn_save(){
    ...
    $.ajax({
            ...
            type: "POST",
            data : {_token:_token,id:id,ruc:ruc,nombre:nombre,direccion:direccion,email:email,telefono:telefono},
			dataType: 'json',
					...
					<div class="row">
						...
						<div class="col-lg-12">
							<div class="form-group">
								...
								<input id="nombre_" name="nombre_" class="form-control form-control-sm"  value="<?php echo $empresa->nombre?>" type="text" readonly>
							</div>
						</div>
	...
	var settings = {
	  ...
	  $.ajax(settings).done(function (response) {
		...
		if (response.success == true){
			...
			$('#nombre_').val(data.nombre_o_razon_social);

...
$('#openOverlayOpc').on('shown.bs.modal', function() {
	$('#fecha_proximo_seguimiento').datepicker({
		format: "dd-mm-yyyy",
		autoclose: true,
		container: '#openOverlayOpc modal-body'
	});
...
function fn_save_seguimiento(){
	...
	var fecha_proximo_seguimiento = $('#fecha_proximo_seguimiento').val();
	
    $.ajax({
			url: "/expediente/send_seguimiento",
            type: "POST",
            data : {_token:_token,id:id,fecha_seguimiento:fecha_seguimiento,estado_proceso:estado_proceso,Observacion:Observacion,fecha_proximo_seguimiento:fecha_proximo_seguimiento},
					...
					<div class="row" style="padding-left:10px">
						...
						<div class="col-lg-12">
							<div class="form-group">
								<label class="control-label form-control-sm">Fecha Seguimiento</label>
								<input type="text" name="fecha_seguimiento" id="fecha_seguimiento"
								value="<?php echo date("d-m-Y", strtotime($seguimiento->fecha_seguimiento))?>" placeholder="" class="form-control form-control-sm col-lg-5" >
							</div>
						</div>
						...
						<div class="col-lg-12">
							<div class="form-group">
								...
								<select name="estado_proceso" id="estado_proceso" class="form-control form-control-sm" onChange="">
									<option value="">--Seleccionar--</option>
									<?php
									foreach ($estado_seguimiento as $row) {?>
									<option value="<?php echo $row->codigo?>" <?php if($row->codigo==$seguimiento->estado_proceso)echo "selected='selected'"?>><?php echo $row->denominacion?></option>
									<?php 
									}
									?>
								</select>
						...
						<div class="col-lg-12">
							<div class="form-group">
								<label class="control-label form-control-sm">Observacion</label>
								<textarea type="text" name="Observacion" id="Observacion" rows="2"
								placeholder="" class="form-control form-control-sm"><?php echo $seguimiento->Observacion?></textarea>
							</div>
						</div>
						
						<div class="col-lg-12">
							<div class="form-group">
								<label class="control-label form-control-sm">Fecha Proximo Seguimiento</label>
								<input type="text" name="fecha_proximo_seguimiento" id="fecha_proximo_seguimiento"
								value="<?php echo date("d-m-Y", strtotime($seguimiento->fecha_proximo_seguimiento))?>" placeholder="" class="form-control form-control-sm col-lg-5" >
							</div>
						</div>
					...
					<div style="margin-top:15px" class="form-group">
						<div class="col-sm-12 controls">
							<div class="btn-group btn-group-sm float-right" role="group" aria-label="Log Viewer Actions">
								<a href="javascript:void(0)" onClick="fn_save_seguimiento()" class="btn btn-sm btn-success">Guardar</a>
							</div>

...
function fn_save(){
    ...
    $.ajax({
			url: "/inversiones/send_inversionista",
            type: "POST",
            data : {_token:_token,id:id,id_persona:id_persona,id_empresa:id_empresa,id_proyecto:id_proyecto},
					...
					<div class="row" style="padding-left:10px">
						...
						<div class="col-lg-12">
							<div class="form-group">
								...
								<select name="id_proyecto" id="id_proyecto" class="form-control form-control-sm" onchange="">
					...
					<div class="row" id="divPersona" style="padding-left:10px;<?php echo $display_persona?>">
						...
						<div class="col-lg-12">
							<div class="form-group">
								...
								<input id="persona_" name="persona_" class="form-control form-control-sm ui-autocomplete-input" value="<?php //if($proveedor->id > 0 && $proveedor->tipo==0)echo $proveedor->proveedor;?>" type="text" autocomplete="off">
								<input id="id_persona" name="id_persona" class="form-control form-control-sm" value="<?php //if($proveedor->id > 0 && $proveedor->tipo==0)echo $proveedor->id_persona;?>" type="hidden">
					...
					<div class="row" id="divEmpresa" style="padding-left:10px;<?php echo $display_empresa?>">
						...
						<div class="col-lg-12">
							<div class="form-group">
								...
								<input id="empresa_" name="empresa_" class="form-control form-control-sm" value="<?php //if($proveedor->id > 0 && $proveedor->tipo==1)echo $proveedor->proveedor;?>" type="text" autocomplete="off">
								<input id="id_empresa" name="id_empresa" class="form-control form-control-sm"  value="<?php //if($proveedor->id > 0 && $proveedor->tipo==0)echo $proveedor->id_empresa;?>" type="hidden">

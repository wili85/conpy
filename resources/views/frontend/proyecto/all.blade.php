...
@section('breadcrumb')
<ol class="breadcrumb" style="padding-left:130px;margin-top:0px;background-color:#283659;color:#FFFFFF">
        <li class="breadcrumb-item">Inicio</li>
            <li class="breadcrumb-item">Registro de Proyectos</li>
        </li>
    </ol>
@endsection
...
@push('after-scripts')
<script src="{{ asset('js/proyecto/lista.js') }}"></script>
@endpush
